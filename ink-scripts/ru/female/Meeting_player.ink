...
Привет.	# actor:player # voiceover:42_privet.ogg
Фух, ты меня напугал.	# actor:female # voiceover:134_fuh_ty_menya_napugal.ogg
Всё в порядке? Ты не заблудилась?	# actor:player # voiceover:43_vsyo_v_poryadke.ogg
...
Давно ты здесь?	# actor:player # voiceover:44_davno_ty_zdes.ogg
Уже несколько часов.	# actor:female # voiceover:136_uzhe_neskolko_chasov.ogg
Туристка?	# actor:player # voiceover:45_turistka.ogg
Ага, я приехала из…	# actor:female # voiceover:137_aga_ya_priehala_iz.ogg
Почему не позвонила в гостиницу?	# actor:player # voiceover:46_pochemu_ne_pozvonila.ogg
Здесь сети нет. А как тебя зовут?	# actor:female # voiceover:138_zdes_seti_net.ogg
Андреас.	# actor:player # voiceover:47_Andreas.ogg
...
Возможно. А что ты так увлечённо читала?	# actor:player # voiceover:48_vozmozhno_a_chto_chitala.ogg
...
И этот пустынный остров значится под номером один?	# actor:player # voiceover:49_pustynnyy_ostrov_nomer_odin.ogg
...
Почему выбрала Грецию?	# actor:player # voiceover:50_pochemu_vybrala_greziyu.ogg
...
Там куда я направляюсь очень опасно. Я не имею права и не хочу подвергать риску никого кроме себя. Иди на берег, там стоит моя лодка. Я скоро приду и отвезу тебя на материк.	# actor:player # voiceover:54_tam_kuda_ya_napravlayus.ogg
...
*	[Взять Ксению с собой.]
	...
	Ладно. Но ты должна во всём меня слушаться.	# actor:player # voiceover:55_ladno_no_ty_dolzhna.ogg
	Здорово! Спасибо, что согласился, ты не пожалеешь.	# actor:female # voiceover:148_zdorovo_spasibo.ogg
	И поменьше болтай.	# actor:player # voiceover:56_i_pomenshe_boltay.ogg
...
*	[Не брать Ксению с собой, отвезти на материк.]
	Ты не поняла. Ты можешь погибнуть.	# actor:player # voiceover:63_ty_ne_ponyala.ogg
	Но ты ведь тоже рискуешь!	# actor:female # voiceover:155_no_ty_ved_tozhe.ogg
	Я взрослый мужчина и сам решаю что мне делать.	# actor:player # voiceover:64_ya_vzrosy_muzhchina.ogg
	Так и я не ребёнок и тоже могу поступать как считаю нуж…	# actor:female # voiceover:156_tak_i_ya_ne_rebenok.ogg
	Хватит. Спорить бессмысленно. Иди на берег и жди меня там.	# actor:player # voiceover:65_hvatia_sporit_bessmyslenno.ogg
	Ладно, я пойду. Угоню твою лодку и затеряюсь в море!	# actor:female # voiceover:157_ladno_ya_poydu.ogg
	~ party_female = false
	Чёрт знает что.	# actor:player # voiceover:66_chyort_znaet_chto.ogg