...
Вы поняли, насколько здесь опасно? Уверены, что стоит продолжать?	# actor:player # voiceover:2528_vy_ponyaly_na_skolko.ogg
Я пойду дальше. Но только один.	# actor:bandit # voiceover:20_ya_poydu_dalshe.ogg
Одному здесь вдвойне опасней.	# actor:player # voiceover:2529_odnomu_zdes_vdvoine.ogg
...
Надо идти всем вместе. Уверен, что впредь каждый из нас будет максимально осторожен.	# actor:player # voiceover:2530_nado_idti_vsem.ogg
...
Думаю мы сможем договориться.	# actor:player # voiceover:2531_dumayu_my_smozhem.ogg
...
* 	(companion_xenia) [Идти с Ксенией.]
	Ксения, пойдём вместе. Макс, присоединяйся.	# actor:player # voiceover:2532_ksenia_poidyom_vmeste.ogg
...
* 	(companion_max) [Идти с Максом.]
	Твой подход, Макс, мне кажется надёжнее, но я не могу позволить Ксении идти одной.	# actor:player # voiceover:2533_tvoy_podhod.ogg
	...
	Разве тебе не любопытно какие загадки  скрывает этот лабиринт? Ты сейчас делаешь вид что уйдёшь, а сама будешь идти за нами.	# actor:player # voiceover:2534_razve_tebe_ne_lubopytno.ogg
	...
	Позвоню, обещаю.	# actor:player # voiceover:2535_pozvonu_obeshayu.ogg
