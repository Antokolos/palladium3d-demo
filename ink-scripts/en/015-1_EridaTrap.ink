The trap still works.	# actor:female # voiceover:565_the_trap_still_works.ogg
Do you hear that hissing sound?	# actor:player # voiceover:485_do_you_hear_that_hissing.ogg
Yes, that sugary smell just became stronger.	# actor:female # voiceover:566_yes_that_sugary_smell.ogg
It's gas coming inside the room. Try to breathe slowly. We need to solve the riddle quickly.	# actor:player # voiceover:486_it's_gas_coming_inside.ogg
